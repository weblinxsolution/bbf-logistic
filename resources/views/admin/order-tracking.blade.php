                                                            ...
                                                            @foreach ($tracking as $track)
                                                                ...
                                                                <div class="d-flex flex-wrap" style="gap: 10px;">
                                                                    ...
                                                                    @foreach ($container as $con)
                                                                        @php
                                                                            $booking_size = App\Models\BookingSize::where('id', $con->booking_size)->first();
                                                                        @endphp
                                                        ...
                                                        <div class="orderstatus ">
                                                            ...
                                                            @if ($loop->iteration <= 2)
                                                                <div class="orderstatus-text">
                                                                    @if ($loop->iteration == 1)
                                                                        <time>{{ \Carbon\Carbon::parse($track->created_order_date)->format('d-m-y') }}</time>
                                                                    @else
                                                                        <time>{{ \Carbon\Carbon::parse($track->pickup_order_date)->format('d-m-y') }}</time>
                                                                    @endif
                                                                    <div class = "d-flex ">
                                                                        @php
                                                            ...
                                                            @elseif ($loop->iteration > 2)
                                                                <div class="orderstatus-text">
                                                                    ...
                                                                    <div class = "w-100 ">
                                                                        @php
                                                                            $status = App\Models\OrderStatus::where('id', $track->order_status_id)->first();
                                                                            $check = App\Models\Check::where('status_id', $track->order_status_id)
                                                                                ->where('status', 1)
                                                                                ->get();
                                                                        @endphp
                                                                        ...
                                                                        @if ($track->cargo_remark != null)
                                                                            <div class="d-flex align-items-center timeline-css">
                                                                                <a href="{{ asset('documents/' . $track->document) }}"
                                                                                    class="btn btn-dark d-block w-mxc  my-1"
                                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                                    title="View"><i
                                                                                        class="fa-regular fa-eye"></i></a>
                                                                                <a href="{{ asset('documents/' . $track->document) }}"
                                                                                    download
                                                                                    class="ml-2 btn btn-dark d-block w-mxc my-1"
                                                                                    data-toggle="tooltip" data-placement="bottom"
                                                                                    title="download"><i
                                                                                        class="fa-solid fa-download"></i></a>
                                                                            </div>
